...
<div class="row">
  ...
  <section class="col-lg-12 connectedSortable hide">
    ...
    <div class="box box-solid bg-teal-gradient">
      <div class="box-header">
        ...
        <h3 class="box-title">Grafik Surat</h3>
      ...
      <div class="box-footer no-border">
        <div class="row">
          <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
            <input type="text" class="knob" data-readonly="true" value="20" data-width="100" data-height="100"
                   data-fgColor="#39CCCC">

            <div class="knob-label">Surat Masuk</div>
          </div>
          <!-- ./col -->
          <div class="col-xs-6 text-center" style="border-right: 1px solid #f4f4f4">
            ...
            <div class="knob-label">Disposisi</div>
          </div>
          <!-- ./col -->
        </div>
        <!-- /.row -->
